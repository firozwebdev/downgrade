            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(4746,$translate,'Color Settings') }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(4749,$translate,'Site Theme Color') }} <span class="require">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(4752,$translate,'Site Button Color') }} <span class="require">*</span></label>
                                             ...
                                             <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(4755,$translate,'Header & Footer BgColor') }} <span class="require">*</span></label>
                             ...
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(4758,$translate,'Site Button Hover Color') }} <span class="require">*</span></label>
                                             ...
                                             <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(4761,$translate,'Copyright BgColor') }} <span class="require">*</span></label>
