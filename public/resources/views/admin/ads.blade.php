            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(4728,$translate,'Ads') }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                           ...
                           {{ csrf_field() }}
                           @endif
                          <div class="col-md-12 mt-3"><h5>Top Ads</h5></div>
                           <div class="col-md-6">
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><strong>{{ Helper::translation(4125,$translate,'Pages') }}</strong> </label><br/>
                             ...
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(4731,$translate,'Example Code') }} </label>
                                                <br> <img src="{{ url('/') }}/resources/views/admin/template/images/ins.png">
                                            </div> 
                                            
                                            
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(4734,$translate,'Ads Code') }}</label>
                             ...
                             <div class="col-md-12 mt-3"><h5>{{ Helper::translation(4737,$translate,'Sidebar Ads') }}</h5></div>
                             <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                             ...
                             <div class="col-md-12 mt-3"><h5>{{ Helper::translation(4740,$translate,'Bottom Ads') }}</h5></div>
                             <div class="col-md-6">
