            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(5088,$translate,'Rating & Reviews') }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    @foreach($itemData['item'] as $rating)
                                        <tr>
                                            ...
                                            <td>
                                            <a href="{{ URL::to('/admin/edit-rating') }}/{{ $rating->rating_id }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp; {{ Helper::translation(4722,$translate,'Edit') }}</a> 
                                            @if($demo_mode == 'on') 
                                            <a href="demo-mode" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>&nbsp;{{ Helper::translation(4725,$translate,'Delete') }}</a>
                                            @else
                                            <a href="{{ URL::to('/admin/rating') }}/{{ $rating->rating_id }}" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure you want to delete?');"><i class="fa fa-close"></i>&nbsp; {{ Helper::translation(4725,$translate,'Delete') }}</a>@endif
