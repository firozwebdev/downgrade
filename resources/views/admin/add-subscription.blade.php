            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation('63885b775d75c',$translate,'Add Pack') }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                ...
                <div class="col-md-12">
                  <div class="card">
                            <div class="card-header">
                                <strong class="card-title">{{ Helper::translation('63885b775d75c',$translate,'Add Pack') }}</strong>
                            </div>
                             <div class="card-body">
                 @if($demo_mode == 'on')
                                 ...
                                 <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @endphp
                                                <option value="{{ $keyval }}">{{ $duration }}</option>
                                                @endforeach
                                                </select>
                                      ...
                                      <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1">{{ Helper::translation(4581,$translate,'') }}</option>
                                                <option value="0">{{ Helper::translation(4584,$translate,'') }}</option>
                                                </select>
