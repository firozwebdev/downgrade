            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation('64009357c474f',$translate,'Add Coupon') }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                ...
                                <div id="pay-invoice">
                                    ...
                                    <div class="form-group">
                                                ...
                                                <select name="discount_type" class="form-control" data-bvalidator="required">
                                                 <option value=""></option>
                                                 <option value="percentage">{{ Helper::translation('640093a1c7145',$translate,'Percentage') }}</option>
                                                 <option value="fixed">{{ Helper::translation('640093ad4e338',$translate,'Fixed') }}</option>
                                                 </select>
                                            </div>
                                    <div class="form-group">
                                       ...
                                       <div class="form-group">
                                                ...
                                                <select name="coupon_status" class="form-control" data-bvalidator="required">
                                                 <option value=""></option>
                                                 <option value="1">{{ Helper::translation(4581,$translate,'Active') }}</option>
                                                 <option value="0">{{ Helper::translation(4584,$translate,'InActive') }}</option>
                                                 </select>
                                            </div>
