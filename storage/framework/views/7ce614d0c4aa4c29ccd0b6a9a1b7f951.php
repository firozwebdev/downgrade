                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th width="10%"><?php echo e(Helper::translation(4713,$translate,'')); ?></th>
                                            <th width="40%"><?php echo e(Helper::translation(4020,$translate,'')); ?></th>
                                            <th width="30%"><?php echo e(Helper::translation(4227,$translate,'')); ?></th>
                                    ...
                                    <?php $__currentLoopData = $templateData['view']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                           ...
                                           <td><a href="edit-email-template/<?php echo e($template->et_id); ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp; <?php echo e(Helper::translation(4722,$translate,'')); ?></a> 
                                            </td>
                                        </tr>
...
<?php /**PATH C:\Users\sabuz\Downloads\downgred latest\downgrade\resources\views/admin/email-template.blade.php ENDPATH**/ ?>