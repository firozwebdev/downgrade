            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(5241,$translate,'Send Newsletter Updates') }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                           ...
                                           <div class="form-group">
                                                <label for="name" class="control-label mb-1">{{ Helper::translation(4023,$translate,'Email') }} <span class="require">*</span></label>
                                                <div class="email-box">
                                                <input type="checkbox" id="select_all" /> <span>{{ Helper::translation(5244,$translate,'Select all') }} </span><br/>
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1">{{ Helper::translation(4227,$translate,'Subject') }} <span class="require">*</span></label>
                                                <input id="news_heading" name="news_heading" type="text" class="form-control" data-bvalidator="required">
                                            </div>
                                            
                                             <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1">{{ Helper::translation(5247,$translate,'Content') }}<span class="require">*</span></label>
