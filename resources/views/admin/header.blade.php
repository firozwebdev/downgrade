...
<div class="user-menu dropdown-menu">
                            <a class="nav-link" href="{{ url('/admin/edit-profile') }}"><i class="fa fa-user"></i> {{ Helper::translation(4032,$translate,'My Profile') }}</a>
                            @if(in_array('settings',$avilable))
                            <a class="nav-link" href="{{ url('/admin/general-settings') }}"><i class="fa fa-cog"></i> {{ Helper::translation(4941,$translate,'Settings') }}</a>
                            @endif
                            <a class="nav-link" href="{{ url('/logout') }}"><i class="fa fa-power-off"></i> {{ Helper::translation(4044,$translate,'Logout') }}</a>
                        </div>
                        </div>
