        ...
        <div class="row">
          ...
          <section class="col-lg-8 pt-2 pt-lg-4 pb-4 mb-lg-3">
            <div class="pt-2 px-4 pr-lg-0 pl-xl-5">
              ...
              <a class="gallery-item rounded-lg mb-grid-gutter" href="{{ url('/') }}/public/storage/product/{{ $item['view']->product_image }}" data-sub-html="{{ $item['view']->product_name }}"><img src="{{ url('/') }}/public/storage/product/{{ $item['view']->product_image }}" alt="{{ $item['view']->product_name }}"/><span class="gallery-item-caption">{{ $item['view']->product_name }}</span></a>
              @else
              ...
              <div class="d-flex flex-wrap justify-content-between align-items-center border-top pt-3">
                <div class="py-2 mr-2">
                  ...
                  <a class="btn btn-outline-accent btn-sm" href="{{ $item['view']->product_demo_url }}" target="_blank"><i class="dwg-eye font-size-sm mr-2"></i>{{ Helper::translation(4143,$translate,'') }}</a>
                  @endif
               ...
               @if(Auth::guest())
                    ...
                    <form action="{{ route('support') }}" class="support_form media-body needs-validation" id="support_form" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="item_url" value="{{ URL::to('/item') }}/{{ $item['view']->product_slug }}">
          ...
          <aside class="col-lg-4">
            ...
            <div class="cz-sidebar-static h-100 ml-auto border-left">
               ...
               @endif 
                ...
                { 
                $item_price = round($item['view']->regular_price/2);
              ...
              <ul class="list-unstyled font-size-sm">
                ...
                <li class="d-flex justify-content-between mb-3 pb-3 border-bottom"><span class="text-dark font-weight-medium title-width">{{ Helper::translation(4203,$translate,'') }}</span><span class="text-muted text-right">
                ...
                <li class="d-flex justify-content-between mb-3 pb-3 border-bottom"><span class="text-dark font-weight-medium title-width">{{ Helper::translation(4206,$translate,'') }}</span><span class="text-muted text-right">       @php $browse_info = ""; @endphp
