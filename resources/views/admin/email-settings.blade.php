            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(4854,$translate,'Email Settings') }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(3987,$translate,'Sender Name') }} <span class="require">*</span></label>
                             ...
                             <div class="card-body">
                              ...
                              <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(3990,$translate,'Sender Email') }} <span class="require">*</span></label>
                             ...
                             <div class="col-md-12"><div class="card-body"><h4>{{ Helper::translation(4857,$translate,'Mail Configuration') }}</h4></div></div>
                             ...
                             <div class="card-body">
                              ...
                              <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(4860,$translate,'Mail Driver') }} <span class="require">*</span></label>
                                  ...
                                  <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(4863,$translate,'Mail Port') }} <span class="require">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(4866,$translate,'Mail Password') }}</label>
                             ...
                             <div class="card-body">
                              ...
                              <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(4869,$translate,'Mail Host') }} <span class="require">*</span></label>
                                    ...
                                    <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(4872,$translate,'Mail Username') }} </label>
                                      ...
                                      <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(4875,$translate,'Mail Encryption') }} </label>
