        ...
        <input type="text" name="site_tawk_chat" id="site_tawk_chat" class="form-control noscroll_textarea" value="{{ $setting['setting']->site_tawk_chat}}" required /><small><strong>Example:</strong> https://embed.tawk.to/609bc139b1d5182476b83612/1fdsadaewr</small>
                                            ...
                                            <div class="form-group">
                                              ...
                                              <select name="subscription_mode" class="form-control" required>
                                                        <option value=""></option>
                                                        <option value="1" @if($allsettings->subscription_mode == 1) selected @endif>{{ Helper::translation('6391e2ff61c06',$translate,'Enable') }}</option>
                                                        <option value="0" @if($allsettings->subscription_mode == 0) selected @endif>{{ Helper::translation('6391e307ac9d7',$translate,'Disable') }}</option>
                                              </select>
                                            </div>    
                                            
                                            <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1">{{ Helper::translation('63f9b5828044e',$translate,'Redeem Voucher Term & Conditions') }}<span class="require">*</span></label>
                             ...
                             <div class="form-group">
                                            ...
                                            <div class="form-group">
                                              <label for="product_approval" class="control-label mb-1">{{ Helper::translation('63ff23f05d38b',$translate,'Google Recaptcha') }}?<span class="require">*</span></label><br/>
                                            ...
                                            <div class="form-group mt-3">
                                             <label for="site_title" class="control-label mb-1">{{ Helper::translation('64ba78b17b062',$translate,'Google Recaptcha Site Key') }}<span class="require">*</span></label>
                                        ...
                                        <div class="form-group">
                                             <label for="site_title" class="control-label mb-1">{{ Helper::translation('64ba78b92160e',$translate,'Google Recaptcha Secret Key') }}<span class="require">*</span></label>
                                            ...
                                            <div class="form-group">
                                              <label for="product_approval" class="control-label mb-1">{{ Helper::translation('6403260fd09dc',$translate,'Product Updates Menu Item') }}?<span class="require">*</span></label><br/>
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation('63948c0c76417',$translate,'Reminder of Subscription renewal before days') }} ({{ Helper::translation(4023,$translate,'Email') }})</label>
                                                ...
                                                <span>({{ Helper::translation(4440,$translate,'days') }})</span>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation('640701c7a983f',$translate,'Product Reporting URL') }}</label>
