                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th width="10%">{{ Helper::translation(4713,$translate,'') }}</th>
                                            <th width="40%">{{ Helper::translation(4020,$translate,'') }}</th>
                                            <th width="30%">{{ Helper::translation(4227,$translate,'') }}</th>
                                    ...
                                    @foreach($templateData['view'] as $template)
                                        <tr>
                                           ...
                                           <td><a href="edit-email-template/{{ $template->et_id }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp; {{ Helper::translation(4722,$translate,'') }}</a> 
                                            </td>
                                        </tr>
