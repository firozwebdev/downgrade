                           ...
                           <div class="col-md-6">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="card-body">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div id="ifwatermark" @if($setting['setting']->watermark_repeat == "0") class="force-block form-group" @else class="force-none form-group" @endif>
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation('6450b5f514810',$translate,'Watermark Position') }}?<span class="require">*</span></label>
                                                <select name="watermark_position" class="form-control" required>
                                                <option value=""></option>
                                                <option value="top-left" @if($setting['setting']->watermark_position == "top-left") selected @endif>Top Left</option>
                                                <option value="top-right" @if($setting['setting']->watermark_position == "top-right") selected @endif>Top Right</option>
                                                <option value="bottom-left" @if($setting['setting']->watermark_position == "bottom-left") selected @endif>Bottom Left</option>
                                                <option value="bottom-right" @if($setting['setting']->watermark_position == "bottom-right") selected @endif>Bottom Right</option>
                                                <option value="center" @if($setting['setting']->watermark_position == "center") selected @endif>Center</option>
                                                </select>
                             ...
                             <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation('6450b5ed59e24',$translate,'Watermark Repeat') }}?<span class="require">*</span></label>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                         ...
                                         <div class="form-group">
                                                ...
                                                <?php /*?><option value="2" @if($setting['setting']->site_s3_storage == 2) selected @endif>{{ Helper::translation('6223403911a49',$translate,'Dropbox Storage') }}</option>
                                                <option value="3" @if($setting['setting']->site_s3_storage == 3) selected @endif>{{ Helper::translation('6223404059682',$translate,'Google Storage') }}</option><?php */?>
                            ...
                            <div class="card-body">
                             ...
                             <?php /* ?><div class="col-md-12"><h5>{{ Helper::translation('622340757bbd3',$translate,'Dropbox Storage Configuration (If dropbox storage selected)') }}</h5></div>
                            <div class="col-md-6">
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
