<div class="cz-sidebar-static rounded-lg box-shadow-lg px-0 pb-0 mb-5 mb-lg-0">
            <div class="px-4 mb-4">
              <div class="media align-items-center">
                ...
                <div class="media-body pl-3">
                  ...
                  @if(Auth::user()->user_subscr_type != '')<span class="badge badge-info">{{ Auth::user()->user_subscr_type }} {{ Helper::translation('639091794db97',$translate,'Membership') }}</span><br/>
                  @if(Helper::lifeTime(Auth::user()->id) == 0)
                  <span class="expire_on"><i class="dwg-time"></i> {{ Helper::translation('639091814cc55',$translate,'Expire On') }} {{ date('d M Y',strtotime(Auth::user()->user_subscr_date)) }}</span>
                  @endif
                  @endif
                  @endif
                </div>
            ...
            <ul class="list-unstyled mb-0">
                  ...
                  <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="{{ URL::to('/redeem-voucher') }}"><i class="dwg-gift opacity-60 mr-2"></i>{{ Helper::translation('63ecc117b626d',$translate,'Redeem Voucher') }}</a></li>
                  <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="{{ url('/my-referral') }}"><i class="dwg-share opacity-60 mr-2"></i>{{ Helper::translation('63fdeb0739ef8',$translate,'My Referral') }}</a></li>
