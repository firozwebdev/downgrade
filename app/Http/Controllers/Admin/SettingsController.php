...
class SettingsController extends Controller
{
  ...
  /* pwa settings */
	...
	public function view_ads()
    {
		...
		$ads_pages = array('home' => 'Home', 'shop' => 'Shop', 'item-details' => 'Item Details', 'featured-items' => 'Featured Items', 'free-items' => 'Free Items', 'new-releases' => 'New Releases', 'popular-items' => 'Popular Items', 'blog' => 'Blog', 'post-details' => 'Post Details', 'contact' => 'Contact', 'flash-sale' => 'Flash Sale', 'tags' => 'Tags', 'pages' => 'Dynamic Pages');
	...
	public function payment_settings()
    {
		...
		$sid = 1;
		$setting['setting'] = Settings::editGeneral($sid);
		$payment_option = array('paypal','wallet','paystack','localbank','razorpay', 'coingate','coinpayments','payhere','payfast','flutterwave','mercadopago','stripe');
