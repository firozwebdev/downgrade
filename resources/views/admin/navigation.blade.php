                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-gear"></i><a href="{{ url('/admin/pwa-settings') }}">{{ Helper::translation('64fc0e9f58370',$translate,'PWA Settings') }}</a></li>
                    ...
                    <li>
                        <a href="{{ url('/admin/subscription') }}"> <i class="menu-icon fa fa-user"></i>{{ Helper::translation('6388592288601',$translate,'Subscription') }} </a>
                    </li>
                    @endif
                    @endif
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/products') }}">{{ Helper::translation(4974,$translate,'Products') }}</a></li>
                            ...
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/attributes') }}">{{ Helper::translation('6397127e58b11',$translate,'Attributes') }}</a></li>
                    ...
                    <li>
                        <a href="{{ url('/admin/voucher-code') }}"> <i class="menu-icon fa fa-gift"></i>{{ Helper::translation('6405c09305f6d',$translate,'Prepaid Vouchers') }} </a>
                    </li>
                    @endif
                    @if(in_array('coupons',$avilable))
                    <li>
                        <a href="{{ url('/admin/coupons') }}"> <i class="menu-icon fa fa-percent"></i>{{ Helper::translation('64071fdcb0ab0',$translate,'Discount Coupons') }} </a>
                    </li>
                    @endif
                    ...
                    <li>
                        <a href="{{ url('/admin/website-maintenance') }}"> <i class="menu-icon fa fa-wrench"></i>{{ Helper::translation('63ff40894b1a1',$translate,'Website Maintenance') }} </a>
                    </li>
                    @endif
                    ...
                    <li>
                        <a href="{{ url('/admin/backup') }}"> <i class="menu-icon fa fa-hdd-o"></i>{{ Helper::translation('64fc0c27cae4e',$translate,'Backups') }} </a>
                    </li>
                    @endif
                  </ul>
            </div><!-- /.navbar-collapse -->
