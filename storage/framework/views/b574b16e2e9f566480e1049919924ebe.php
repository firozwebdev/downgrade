...
<div class="user-menu dropdown-menu">
                            <a class="nav-link" href="<?php echo e(url('/admin/edit-profile')); ?>"><i class="fa fa-user"></i> <?php echo e(Helper::translation(4032,$translate,'My Profile')); ?></a>
                            <?php if(in_array('settings',$avilable)): ?>
                            <a class="nav-link" href="<?php echo e(url('/admin/general-settings')); ?>"><i class="fa fa-cog"></i> <?php echo e(Helper::translation(4941,$translate,'Settings')); ?></a>
                            <?php endif; ?>
                            <a class="nav-link" href="<?php echo e(url('/logout')); ?>"><i class="fa fa-power-off"></i> <?php echo e(Helper::translation(4044,$translate,'Logout')); ?></a>
                        </div>
                        </div>
                 ...
                 <?php endif; ?> 
                    ...
                    <?php /**PATH C:\Users\sabuz\Downloads\downgred latest\downgrade\resources\views/admin/header.blade.php ENDPATH**/ ?>