            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation('6261373b555a9',$translate,'Edit Sub Category') }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <label for="subcategory_name" class="control-label mb-1">{{ Helper::translation('62612871df65f',$translate,'Sub Category') }} <span class="require">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="subcategory_name" class="control-label mb-1">{{ Helper::translation(4590,$translate,'') }}</label>
