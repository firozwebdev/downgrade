            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(4815,$translate,'Edit Blog Category') }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" @if($edit['category']->blog_category_status == 1) selected="selected" @endif>{{ Helper::translation(4581,$translate,'Active') }}</option>
                                                <option value="0" @if($edit['category']->blog_category_status == 0) selected="selected" @endif>{{ Helper::translation(4584,$translate,'InActive') }}</option>
                                                </select>
