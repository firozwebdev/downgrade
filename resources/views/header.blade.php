<header class="bg-light box-shadow-sm navbar-sticky">
      ...
      <div class="topbar topbar-dark bg-dark">
        ...
        <div class="topbar-text dropdown d-md-none ml-auto"><a class="topbar-link dropdown-toggle" href="#" data-toggle="dropdown">{{ Helper::translation(3999,$translate,'') }}@if($allsettings->site_blog_display == 1) / {{ Helper::translation(3867,$translate,'') }}@endif</a>
            <ul class="dropdown-menu dropdown-menu-right">
              <li><a class="dropdown-item" href="{{ URL::to('/contact') }}"><i class="dwg-support text-muted mr-2"></i>{{ Helper::translation(3999,$translate,'') }}</a></li>
              @if($allsettings->site_blog_display == 1)
              <li><a class="dropdown-item" href="{{ URL::to('/blog') }}"><i class="dwg-image text-muted mr-2"></i>{{ Helper::translation(3867,$translate,'') }}</a></li>
              @endif
            </ul>
          </div>
          <div class="d-none d-md-block ml-3 text-nowrap">
          <a class="topbar-link ml-3 pl-3 border-left border-light d-none d-md-inline-block" href="{{ URL::to('/contact') }}"><i class="dwg-support mt-n1"></i>{{ Helper::translation(3999,$translate,'') }}</a>
          @if($allsettings->site_blog_display == 1)
          <a class="topbar-link ml-3 border-left border-light pl-3 d-none d-md-inline-block" href="{{ URL::to('/blog') }}"><i class="dwg-image mt-n1"></i>{{ Helper::translation(3867,$translate,'') }}</a>
          @endif
          </div>
         </div> 
      </div>
          ...
          @endif
            <div class="navbar-toolbar d-flex align-items-center order-lg-3">
              <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarCollapse"><span class="navbar-toggler-icon"></span></button><a class="navbar-tool d-none d-lg-flex" href="#searchBox" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="searchBox"><span class="navbar-tool-tooltip">{{ Helper::translation(4104,$translate,'') }}</span>
                ...
                <a class="dropdown-item d-flex align-items-center" href="{{ URL::to('/redeem-voucher') }}"><i class="dwg-gift opacity-60 mr-2"></i>{{ Helper::translation('63ecc117b626d',$translate,'Redeem Voucher') }}</a>
                <a class="dropdown-item d-flex align-items-center" href="{{ URL::to('/my-referral') }}"><i class="dwg-share opacity-60 mr-2"></i>{{ Helper::translation('63fdeb0739ef8',$translate,'My Referral') }}</a>
            ...
            <div class="collapse navbar-collapse mr-auto order-lg-2" id="navbarCollapse">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown"><a class="nav-link" href="{{ url('/subscription') }}">{{ Helper::translation('6388592288601',$translate,'Subscription') }}</a></li>
                @endif
                ...
                <li class="nav-item dropdown"><a class="nav-link red-color" href="{{ URL::to('/updates') }}">{{ Helper::translation('6405a7396a93b',$translate,'Updates') }}</a></li>
                @endif
               </ul>
            </div>
          </div>
